...
// 👈 퀀트 지표 레이아웃 무리하게 수정해서 꼬이기 시작한 시점(Step 1058~)을 차단하고,
// 그 직전인 Step 1057 (구문 검사 통과 및 모든 기능 정상 작동 골든 버전) 시점까지의 데이터만 조립합니다.
const maxAllowedStep = 1057;

console.log(`Starting pure golden reassembly targeting Step ${maxAllowedStep} of previous log...`);
...
lines.forEach((line, index) => {
    ...
    try {
        ...
        // 지정한 step 이후는 퀀트 수정 꼬임 영역이므로 완전히 차단!
...
console.log(`\nSuccessfully processed ${processedViewsCount} views from golden era.`);
